...
type OrbitControlsProps = Partial<Omit<ReturnType<typeof createControls>["scope"], "camera">>;
type OrbitControlsChangeEvent = Parameters<ReturnType<typeof createControls>["scope"]["onChange"]>[0];

declare function useControls(): readonly [(props: OrbitControlsProps) => React.JSX.Element, {
    onLayout(event: react_native.LayoutChangeEvent): void;
    onStartShouldSetResponder(event: react_native.GestureResponderEvent): boolean;
...
export { type OrbitControlsChangeEvent, type OrbitControlsProps, useControls as default };
